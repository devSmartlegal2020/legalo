...
const PromoHeroSection = ({ onOpenModal }: PromoHeroSectionProps) => {
  const sectionRef = useRef<HTMLDivElement>(null);
  const { isReady } = useLoading();

  const headlineWords = [
    { text: 'Promo', accent: true },
    { text: 'Terbaru', accent: false },
    { text: 'Legalo.id', accent: true },
  ];
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0">
        <picture>
          <source 
            srcSet="https://images.unsplash.com/photo-1553729459-efe14ef6055d?w=1920&q=80" 
            type="image/webp" 
          />
          <img 
            src="https://images.unsplash.com/photo-1553729459-efe14ef6055d?w=1920&q=80"
            alt="Special promotions and offers"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-end">
            ...
            <div className="lg:col-span-4 lg:pb-4">
              <p className="hero-desc text-white/70 text-base lg:text-lg leading-relaxed opacity-0">
                Temukan penawaran eksklusif dan terbatas untuk layanan hukum Legalo.id. Dapatkan diskon spesial dan paket bundling untuk bisnis Anda.
              </p>
            </div>
          </div>
