...
interface EbookHeroSectionProps {
  onOpenModal?: () => void;
}

const EbookHeroSection = ({ onOpenModal }: EbookHeroSectionProps) => {
  const sectionRef = useRef<HTMLDivElement>(null);
  const { isReady } = useLoading();

  const headlineWords = [
    { text: 'E-book', accent: true },
    { text: 'Library', accent: false },
    { text: '&', accent: false },
    { text: 'Newsletter', accent: true },
  ];
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0">
        <picture>
          <source 
            srcSet="https://images.unsplash.com/photo-1495446815901-a7297e633e8d?w=1920&q=80" 
            type="image/webp" 
          />
          <img 
            src="https://images.unsplash.com/photo-1495446815901-a7297e633e8d?w=1920&q=80"
            alt="E-books and resources"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-end">
            ...
            <div className="lg:col-span-4 lg:pb-4">
              <p className="hero-desc text-white/70 text-base lg:text-lg leading-relaxed opacity-0">
                Akses koleksi e-book legal dan bisnis gratis yang dirancang khusus untuk UMKM dan startup. Berlangganan untuk mendapatkan insight eksklusif.
              </p>
            </div>
          </div>
