...
const EventsHeroSection = ({ onOpenModal }: EventsHeroSectionProps) => {
  const sectionRef = useRef<HTMLDivElement>(null);
  const { isReady } = useLoading();

  const headlineWords = [
    { text: 'Upcoming', accent: false },
    { text: 'Events', accent: true },
    { text: '&', accent: false },
    { text: 'Workshops', accent: true },
  ];
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0">
        <picture>
          <source 
            srcSet="https://images.unsplash.com/photo-1540575467063-178a50c2df87?w=1920&q=80" 
            type="image/webp" 
          />
          <img 
            src="https://images.unsplash.com/photo-1540575467063-178a50c2df87?w=1920&q=80"
            alt="Business events and workshops"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-end">
            ...
            <div className="lg:col-span-4 lg:pb-4">
              <p className="hero-desc text-white/70 text-base lg:text-lg leading-relaxed opacity-0">
                Legalo.id mengadakan event, workshop, dan webinar untuk membantu UMKM, startup, dan bisnis memahami legalitas dan kepatuhan bisnis.
              </p>
            </div>
          </div>
